const AboutSection = () => {
    return (
        <section className="px-6 py-16 text-gray-800 bg-white md:px-12 lg:px-20 pt-28">
            <div className="mx-auto text-center max-w-7xl">
                <h2 className="mb-6 font-sans text-4xl font-extrabold text-[#003366]">About JUST Debate Club</h2>
