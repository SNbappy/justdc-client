...
const WhatMakesUsStandOut = () => {
    return (
        <div className='bg-fixed bg-cover' style={
            ...
            <div className='px-4 py-10 bg-white bg-opacity-80 md:py-20 xl:py-[90px] sm:px-8 md:px-12 xl:px-0'>
                <div className='max-w-[970px] mx-auto'>
                    ...
                    <p className='py-8 text-xl text-center'>The JUST Debate Club is more than just a platform for debates; it’s a thriving community where passion meets purpose. Unlike
                    ...
                    <div className='flex flex-col items-center justify-center gap-4 mx-auto font-sans uppercase xl:flex-row'>
                        <div className="w-full md:w-3/5">
                            <button className="rounded-full px-14 py-4 font-sans uppercase font-semibold text-[#003366] border-2 border-[#003366] hover:bg-[#003366] hover:text-white text-base w-full text-center">
                                Discover Our Story
                            </button>
                        </div>
                        <div className="w-full md:w-3/5">
                            <button className="rounded-full px-14 py-4 font-sans uppercase font-semibold text-[#003366] border-2 border-[#003366] hover:bg-[#003366] hover:text-white text-base w-full">
                                Meet Our Team
                            </button>
                        </div>
                        <div className="w-full md:w-3/5">
